<template>
	<view class="evan-step" :class="'evan-step--'+direction">
		...
		<view class="evan-step__content" :class="'evan-step__content--'+direction" :style="{height:contentHeight}">
			<text ref="content" class="evan-step__content__title" :class="'evan-step__content__title--'+direction" :style="{color:titleColor}">{{createTime}}</text>
			<text ref="title" v-if="title" class="evan-step__content__description" 
			 :style="{color:descriptionColor}">{{title}}</text>
			 <text ref="distribution" v-if="distribution" class="evan-step__content__description"
			  :style="{color:descriptionColor}">{{distribution}}</text>
			  <text ref="description" v-if="description" class="evan-step__content__description"
			   :style="{color:descriptionColor}">{{description}}</text>
			 <text ref="subdescription" v-if="subdescription" class="evan-step__content__description" :class="'evan-step__content__description--'+direction"
			  :style="{color:descriptionColor}">{{subdescription}}</text>
			<view class="imgview" v-if="ImgData.length!=0">
				 <block v-for="item in ImgData">
					 
			 	<image class="imgClass" mode="aspectFill" :src="item" ></image>
				</block>
			 </view>
